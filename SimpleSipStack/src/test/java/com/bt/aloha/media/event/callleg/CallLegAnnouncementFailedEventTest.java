...
public class CallLegAnnouncementFailedEventTest {
	@Test
	public void testAnnouncementFailedEvent() throws Exception {
		CallLegAnnouncementFailedEvent e = new CallLegAnnouncementFailedEvent(new DialogAnnouncementFailedEvent("test", "cmd"));
