...
public class StackManagerSyncronizationSemaphoreImpl implements
		StackManagerSyncronizationSemaphore {
	...
	public void waitForAll(){
		...
		while(semaphore.availablePermits()>0 || c>0){
			log.debug(String.format("Waiting %ss for all threads to consume the permits. Permits left: %s", (c0 - c),semaphore.availablePermits()));
			sleep(1000);
			c--;
		}
	}
