...
public class AnnouncementCallScenarioExtractor extends ScenarioExtractor {
    ...
    public AnnouncementCallScenarioExtractor(String filename) {
    	super(filename);
        init();
    }
...
//      new ScenarioExtractor(args[0]).doit(args[1]);
          new AnnouncementCallScenarioExtractor("app.log").doit(
"announcementCallScenario:13c3e5b578c2a7c626a4a13c53f785d2");
    }
}
