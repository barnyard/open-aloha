...
/**
 * play an annoucement to a call leg and then terminate the leg
 */
public class PlayAnnouncement implements CallListener, MediaCallListener {
    ...
    public PlayAnnouncement(String mediaFile) {
        this.mediaFile = mediaFile;
    }

    public void playAnnouncement(String callee) throws Exception {
    ...
    public void onCallConnected(CallConnectedEvent arg0) {
        ...
        if (arg0.getCallId().equals(this.callId)) {
            this.commandId = mediaCallBean.playAnnouncement(this.callId, this.mediaFile);
    ...
    public static void main(String[] args) throws Exception {
        new PlayAnnouncement("/provisioned/behave.wav").playAnnouncement("sip:adrian@132.146.185.199");
    }
}
