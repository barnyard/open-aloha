 ...
 *
 */
public class CallAnswerTimeoutScenarioExtractor extends ScenarioExtractor {
    ...
    public CallAnswerTimeoutScenarioExtractor(String filename) {
    	super(filename);
        init();
    }
...
//      new ScenarioExtractor(args[0]).doit(args[1]);
          new CallAnswerTimeoutScenarioExtractor("D:/Documents and Settings/802083751/Desktop/app.log").doit(
"callAnswerTimeoutScenario:0e8fe184815b692c50ad4852c3613ded");
//          "callAnswerTimeoutScenario:7d6e4fb5ea4a280b406c4d2cbdcb0c9d");
    }
}
