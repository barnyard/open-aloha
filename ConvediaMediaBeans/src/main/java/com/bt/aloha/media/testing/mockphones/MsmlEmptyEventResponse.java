...
public class MsmlEmptyEventResponse extends MsmlEventResponse {
	
	public MsmlEmptyEventResponse(String commandId, MsmlApplicationEventType eventType) {
		super(commandId, eventType);
	}
