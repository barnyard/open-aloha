...
public class CallLegDtmfGenerationCompletedEventTest {
	@Test
	public void testConstructor() throws Exception {
		// act
		CallLegDtmfGenerationCompletedEvent e = new CallLegDtmfGenerationCompletedEvent(new DialogDtmfGenerationCompletedEvent("a", "b"));
