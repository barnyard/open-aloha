...
public class CallLegAnnouncementCompletedEventTest {

    // test constructor - not barged
    @Test
    public void testAnnouncementCompletedEventNotBarged() {
    	CallLegAnnouncementCompletedEvent e = new CallLegAnnouncementCompletedEvent(new DialogAnnouncementCompletedEvent("test", "cmd", "1", false));
    ...
    public void testAnnouncementCompletedEventBarged() {
    	CallLegAnnouncementCompletedEvent e = new CallLegAnnouncementCompletedEvent(new DialogAnnouncementCompletedEvent("test", "cmd", "1", true));
        assertEquals("test", e.getId());
