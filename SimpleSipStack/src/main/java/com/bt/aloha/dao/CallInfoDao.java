...
public interface CallInfoDao {
    void create(CallInfo callInfo);
    CallInfo read(String callId);
    void delete(String callId);
    void update(CallInfo callInfo);
    int size();
    CallInfo findCallForDialogId(String dialogId);
    CallInfo findCallForDialogId(String dialogId, String ignoreCallId);
    ...
    ConcurrentMap<String, CallInfo> getAll();
    ConcurrentMap<String, CallInfo> findConnectedMaxDurationCalls();
    long countByCallState(CallState state, Set<String> callIds);
}
