 ...
 */
public class CallAnswerTimeoutScenario extends BatchTestScenarioBase implements CallListener, Resetable {
	...
	protected void startScenario(String scenarioId) throws Exception {
		String firstDialogId = outboundCallLegBean.createCallLeg(getFromAddressUri(), getCallAnswerTimeoutEndpointUri(), 100);
