...
/**
 * Event that is fired when a call is disconnected
 */
public class CallDisconnectedEvent extends AbstractCallEndedEvent {
    /**
     * Constructor
     ...
     */
	public CallDisconnectedEvent(String aCallId, CallTerminationCause aCallTerminationCause, CallLegCausingTermination aCallLegCausingTermination, int aDuration) {
