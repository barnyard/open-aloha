...
public class ConferenceEndedEventTest {

	// test constructor
    @Test
    public void testConferenceEndedEvent() {
        ConferenceEndedEvent e = new ConferenceEndedEvent("test", ConferenceTerminationCause.EndedByApplication, 2000);

        assertEquals("test", e.getConferenceId());
        assertEquals(ConferenceTerminationCause.EndedByApplication, e.getConferenceTerminationCause());
        assertEquals(2000, e.getDuration());
    }
}
