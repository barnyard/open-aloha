...
public class ShootistAuthGaf implements SipListener {
	...
	long invco = 1;
        String peerHostPort = "sip.gafachi.com";
        String transport = "udp";
        String USER_AUTH = "a4369s4MNuhqieWb";
        String PASS_AUTH = "pLM8cvjKB81NUN31";
        String realm = "sip.gafachi.com";
		...
		try {
			if (response.getStatusCode() == Response.OK) {
				if (cseq.getMethod().equals(Request.INVITE)) {
					...
					Request ackRequest = dialog.createAck(2);
	...
	public void sendCancel() {
		...
		//cseqHeader.setSeqNumber(2);
		//requestauth.setHeader(cseqHeader);
		    ...
		    ((CSeqHeader)requestauth.getHeader(CSeqHeader.NAME)).setSeqNumber(2);
        ...
        public Request createInvite(String callId)
            throws ParseException, InvalidArgumentException{
                String fromName = "a4369s4MNuhqieWb";
		String fromSipAddress = "here.com";
		String fromDisplayName = "The Master Blaster";

		String toSipAddress = "sip.gafachi.com";
		String toUser = "011447917024142";
		String toDisplayName = "Joe Darling";
		...
		ViaHeader viaHeader = headerFactory.createViaHeader("192.168.1.11", sipProvider.getListeningPoint(transport).getPort(),transport, null);
		//viaHeader.setRPort();
		// add via headers
	...
	public void init() {
		...
		try {
			...
			udpListeningPoint = sipStack.createListeningPoint("192.168.1.11",10000, "udp");
			sipProvider = sipStack.createSipProvider(udpListeningPoint);
			ShootistAuthGaf listener = this;
