...
public class MsmlResponseParserExceptionTest {
    ...
    public void testStringConstructor() {
        assertEquals("shit happens", new MsmlParseException("shit happens").getMessage());
    }
    ...
    public void testStringAndThrowableConstructor() {
        ...
        MsmlParseException mrp = new MsmlParseException("shit happens", e);
        assertEquals("shit happens", mrp.getMessage());
        assertEquals("nested", mrp.getCause().getMessage());
    }
}
