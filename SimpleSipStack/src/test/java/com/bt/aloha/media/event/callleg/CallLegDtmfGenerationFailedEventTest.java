...
public class CallLegDtmfGenerationFailedEventTest {
	@Test
	public void testConstructor() throws Exception {
		// act
		CallLegDtmfGenerationFailedEvent e = new CallLegDtmfGenerationFailedEvent(new DialogDtmfGenerationFailedEvent("a", "b"));
