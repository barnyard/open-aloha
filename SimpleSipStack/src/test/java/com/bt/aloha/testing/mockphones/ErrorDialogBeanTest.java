...
public class ErrorDialogBeanTest extends SimpleSipStackPerClassTestCase{
	...
	public void testInboundDialogDelegation() throws Exception {
		// setup
		this.setOutboundCallTargetUsername("error");
		...
		assertEquals(Response.SERVER_INTERNAL_ERROR, this.getOutboundCall().getReturnCode());
