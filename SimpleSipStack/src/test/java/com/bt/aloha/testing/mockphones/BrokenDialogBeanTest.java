...
public class BrokenDialogBeanTest extends SimpleSipStackPerClassTestCase {
	...
	public void testInboundDialogDelegation() throws Exception {
		// setup
		this.setOutboundCallTargetUsername("broken");
		
		// act
		assertTrue(this.getOutboundCall().initiateOutgoingCall(this.getRemoteSipAddress(), this.getRemoteSipProxy()));
		
		// assert
		assertOutboundCallResponses(new int[] {Response.SERVICE_UNAVAILABLE});		
	}	
}
