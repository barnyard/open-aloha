...
/**
 * Event that is fired when a call is terminated
 */
public class CallTerminatedEvent extends AbstractCallEndedEvent {
    /**
     * Constructor
     ...
     */
	public CallTerminatedEvent(String aCallId, CallTerminationCause aCallTerminationCause, CallLegCausingTermination aCallLegCausingTermination, int aDuration) {
