...
require 'participantadmin_controller'

# Re-raise errors caught by the controller.
class ParticipantadminController; def rescue_action(e) raise e end; end

class ParticipantadminControllerTest < Test::Unit::TestCase
  fixtures :participants

  def setup
    @controller = ParticipantadminController.new
