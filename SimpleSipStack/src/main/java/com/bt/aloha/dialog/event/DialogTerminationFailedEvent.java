...
public class DialogTerminationFailedEvent extends AbstractDialogEvent {
	private TerminationCause terminationCause;
	
	public DialogTerminationFailedEvent(String aDialogId, TerminationCause aTerminationCause) {
		super(aDialogId);
