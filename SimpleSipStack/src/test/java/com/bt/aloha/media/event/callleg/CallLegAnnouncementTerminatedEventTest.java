...
public class CallLegAnnouncementTerminatedEventTest {

    // test constructor - not barged
    @Test
    public void testAnnouncementTerminatedEventNotBarged() {
    	CallLegAnnouncementTerminatedEvent e = new CallLegAnnouncementTerminatedEvent(new DialogAnnouncementTerminatedEvent("test", "cmd"));
