 ...
 * Create 2 dialogs.
 * Join them.
 * Have the 1st dialog simulate an internal server error.
 * Wait for CallConnectionFailedEvent.
 */
public class FirstCallLegFailureScenario extends BatchTestScenarioBase implements CallListener, Resetable {
	...
	protected void startScenario(String scenarioId) throws Exception {
		String firstDialogId = outboundCallLegBean.createCallLeg(getFromAddressUri(), getRejectTestEndpointUri());
