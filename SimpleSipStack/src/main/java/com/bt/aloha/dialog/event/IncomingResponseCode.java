...
public enum IncomingResponseCode {
	...
	Busy				(Response.BUSY_HERE),
	ServiceUnavailable	(Response.SERVICE_UNAVAILABLE),
	Forbidden			(Response.FORBIDDEN),
	Decline				(Response.DECLINE);
	
	private int sipResponseCode;
	
	private IncomingResponseCode(int newSipResponseCode) {
		this.sipResponseCode = newSipResponseCode;
	}
