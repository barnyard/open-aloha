...
public class DialogConnectionFailedEvent extends AbstractDialogEvent {
	private TerminationCause terminationCause;
	
	public DialogConnectionFailedEvent(String aDialogId, TerminationCause aTerminationCause) {
		super(aDialogId);
