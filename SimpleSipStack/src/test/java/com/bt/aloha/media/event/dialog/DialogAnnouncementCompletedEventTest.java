...
public class DialogAnnouncementCompletedEventTest {

    // test constructor - not barged
    @Test
    public void testAnnouncementCompletedEventNotBarged() {
    	DialogAnnouncementCompletedEvent e = new DialogAnnouncementCompletedEvent("test", "cmd", "1", false);
    ...
    public void testAnnouncementCompletedEventBarged() {
    	DialogAnnouncementCompletedEvent e = new DialogAnnouncementCompletedEvent("test", "cmd", "1", true);
