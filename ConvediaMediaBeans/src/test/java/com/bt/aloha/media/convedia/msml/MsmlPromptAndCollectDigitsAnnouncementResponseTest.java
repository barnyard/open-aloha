...
public class MsmlPromptAndCollectDigitsAnnouncementResponseTest {

//	 Test generation of the announcement response
	@Test
	public void testDtmfPlayCommandFinished() throws Exception {
		//setup
		//act
		String command = new MsmlPromptAndCollectDigitsAnnouncementResponse("123", "100ms", "play.complete").getXml();

		//assert
		assertTrue(command.indexOf("<?xml version=\"1.0\" encoding=\"US-ASCII\"?>") > -1);
		assertTrue(command.indexOf("<msml version=\"1.0\">") > -1);
		assertTrue(command.indexOf("<event name=\"app.dtmfPlayCommandComplete\" id=\"1.2.3.4:5;dialog:123\">") > -1);
	...
	public void testNullPlayAmount() throws Exception {
		//act
		MsmlPromptAndCollectDigitsAnnouncementResponse resp = new MsmlPromptAndCollectDigitsAnnouncementResponse("12", null, "play.complete");
	...
	public void testNullPlayStatus() throws Exception {
		//act
		MsmlPromptAndCollectDigitsAnnouncementResponse resp = new MsmlPromptAndCollectDigitsAnnouncementResponse("12", "100ms", null);
