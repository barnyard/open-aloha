...
/**
 * Event that is fired when a call termination fails
 */
public class CallTerminationFailedEvent extends AbstractCallEndedEvent {
    /**
     * Constructor
     ...
     */
	public CallTerminationFailedEvent(String aCallId, CallTerminationCause aCallTerminationCause, CallLegCausingTermination aCallLegCausingTermination, int aDuration) {
